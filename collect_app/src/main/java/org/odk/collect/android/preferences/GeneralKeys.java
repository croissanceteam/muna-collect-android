...
public final class GeneralKeys {
    ...
    private static HashMap<String, Object> getHashMap() {
        ...
        hashMap.put(KEY_USERNAME,                   Collect.getInstance().getString(R.string.username_login));
        hashMap.put(KEY_PASSWORD,                   Collect.getInstance().getString(R.string.password_login));
        // form_management_preferences.xml
