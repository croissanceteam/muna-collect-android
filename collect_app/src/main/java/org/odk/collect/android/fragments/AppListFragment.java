...
abstract class AppListFragment extends ListFragment {
    ...
    public static void toggleButtonLabel(FloatingActionButton fab, ListView lv, Activity activity) {
        if (lv.getCheckedItemCount() != lv.getCount()) {
            fab.setImageDrawable(activity.getResources().getDrawable(R.drawable.ic_notes_white));
        } else {
            fab.setImageDrawable(activity.getResources().getDrawable(R.drawable.ic_notes_white));
        }
    }
