...
abstract class AppListActivity extends CollectAbstractActivity {
    ...
    public static void toggleButtonLabel(FloatingActionButton toggleButton, ListView lv,Activity activity) {
        if (lv.getCheckedItemCount() != lv.getCount()) {
            toggleButton.setImageDrawable(activity.getResources().getDrawable(R.drawable.ic_notes_white));
        } else {
            toggleButton.setImageDrawable(activity.getResources().getDrawable(R.drawable.ic_clear_white));
        }
    }
